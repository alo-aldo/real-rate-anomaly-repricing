...
Generated outputs, paper tables, figures, manifests, and manuscript audit artifacts are included in this repository. The manifests document the verified source inputs used in the locked analysis:
